...
function documentActions(e) {
    ...
    if (subMenu) {
        ...
        document.documentElement.clientWidth < 992 ? subMenu.classList.add('_sub-menu-open') : subMenu.classList.toggle('_sub-menu-open');
    ...
    if (targetElement.closest('.menu-catalog__back')) {
        ...
        document.querySelector('._sub-menu-active') ? document.querySelector('._sub-menu-active').classList.remove('sub-catalog-active') : null;
        document.querySelector('._sub-menu-open') ? document.querySelector('._sub-menu-open').classList.remove('sub-catalog-open') : null;
        e.preventDefault();
    }
